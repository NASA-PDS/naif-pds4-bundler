...
def test_im_xml_incoherent(self):
    ...
    Test is successful if the following error message is provided::
        ...
        RuntimeError: PDS4 Information Model 1600 is incoherent with the XML Model version:
        http://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1500.sch.
    """
    post_setup(self)
    with open(self.config, "r") as c:
        with open(self.updated_config, "w") as n:
...
def test_im_schema_incoherent(self):
    ...
    Test is successful if the following error message is provided::
        ...
        RuntimeError: PDS4 Information Model 1500 is incoherent with the Schema location:
        http://pds.nasa.gov/pds4/pds/v1 https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1A00.xsd.
    """
    post_setup(self)
    with open(self.config, "r") as c:
        with open(self.updated_config, "w") as n:
        ...
        with open(self.updated_config, "w") as n:
            for line in c:
                if "<information_model>1.5.0.0</information_model>" in line:
                    ...
                    n.write(
                        "<schema_location>http://pds.nasa.gov/pds4/pds/v1 "
                        "https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1J00.xsd</schema_location>\n"
                    )
                else:
                    n.write(line)
        ...
        with open(self.updated_config, "w") as n:
            for line in c:
                if "<information_model>1.5.0.0</information_model>" in line:
                    ...
                    n.write(
                        "<schema_location>http://pds.nasa.gov/pds4/pds/v1 "
                        "https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1F00.xsd</schema_location>\n"
                    )
                else:
                    n.write(line)
        ...
        with open(self.updated_config, "w") as n:
            for line in c:
                if "<information_model>1.5.0.0</information_model>" in line:
                    ...
                    n.write(
                        "<schema_location>http://pds.nasa.gov/pds4/pds/v1 "
                        "https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1C00.xsd</schema_location>\n"
                    )
                else:
                    n.write(line)
        ...
        with open(self.updated_config, "w") as n:
            for line in c:
                if "<information_model>1.5.0.0</information_model>" in line:
                    ...
                    n.write(
                        "<schema_location>http://pds.nasa.gov/pds4/pds/v1 "
                        "https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1B00.xsd</schema_location>\n"
                    )
                else:
                    n.write(line)
