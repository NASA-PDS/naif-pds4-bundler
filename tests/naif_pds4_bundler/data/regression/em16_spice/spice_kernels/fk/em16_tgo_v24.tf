...
------------------------------------------------------------------------
   ...
   Version 2.4 -- October 28, 2021 --  Ricardo Valles Blanco, ESAC/ESA
                                       Alfredo Escalante Lopez, ESAC/ESA

      Updated TGO_NOMAD_SO boresight misalignment with values sent by
      email from Ian Thomas. [23]

   Version 2.3 -- July 9, 2021 --  Ricardo Valles Blanco, ESAC/ESA
                                   Marc Costa Sitja, NAIF/JPL

      Added missing TGO_SA+Z and TGO_SA-Z NAIF ID Codes to
      'TGO NAIF ID Codes -- Summary Section'.

      Corrected typos and reformatted text.

      Updated TIRVIM scanner reference frames and descriptions.

   Version 2.2 -- April 7, 2021 --  Ricardo Valles Blanco, ESAC/ESA

      Fixed typos for PDS4 Bundle release Version 3.0, and updated
      contact information.

   Version 2.1 -- November 5, 2020 --  Alfredo Escalante Lopez, ESAC/ESA
                                       Marc Costa Sitja, ESAC/ESA

      Added ephemeris points for TGO S/C Bus.

      Corrected fixed frames for TIRVIM scanner occultation, space
      and Sun channel.

      Corrected typos in NOMAD description.

   Version 2.0 -- September 24, 2020 --  Marc Costa Sitja, ESAC/ESA
                                         Alfredo Escalante Lopez, ESAC/ESA

      Updated several TGO structures centers for DSK Surfaces.

   Version 1.9 -- March 4, 2020 --  Marc Costa Sitja, ESAC/ESA

      Added several TGO structures NAIF IDs and body names.
...
------------------------------------------------------------------------
   ...
   23. Email from Ian Thomas <ian.thomas@aeronomie.be> ``[EM16-uplink] SO
       boresight vector for MTP049 / new NOMAD SO boresight vector for SPICE
       team'' on 26 October 2021.
...
------------------------------------------------------------------------
   ...
   TGO Spacecraft and Spacecraft Structures names/IDs:
            ...
            TGO                      -143     (synonyms: TRACE GAS ORBITER,
                                                         EXOMARS TGO,
                                                    and  EXOMARS 2016 TGO)
            TGO_SPACECRAFT           -143000
            TGO_SPACECRAFT_C1        -143501
            TGO_SPACECRAFT_C2        -143502
            TGO_SPACECRAFT_C3        -143503
            TGO_SPACECRAFT_C4        -143504
            TGO_SPACECRAFT_C5        -143505
            TGO_SPACECRAFT_C6        -143506
            TGO_SPACECRAFT_C7        -143507
            TGO_SPACECRAFT_C8        -143508
            TGO_SPACECRAFT_C9        -143509
            TGO_SPACECRAFT_C10       -143510
            TGO_SPACECRAFT_C11       -143511
            TGO_SPACECRAFT_C12       -143512
...
--------------------------------------
   ...
   \begindata
      ...
      FRAME_-143000_CENTER             = -143000
      CK_-143000_SCLK                  = -143
      CK_-143000_SPK                   = -143000
...
--------------------------------------------------------------------------
   ...
   \begindata
      ...
      FRAME_-143013_CENTER            = -143013
      CK_-143013_SCLK                 = -143
      CK_-143013_SPK                  = -143013
...
---------------------------
   ...
   The TGO_HGA frame is defined as a fixed offset frame relative to the
...
--------------------------------------------------------------------------
   ...
   There are two Star Trackers (STRs) mounted close to the PLM Instruments,
   on a dedicated panel attached to the 2 PLM Bench panels with
   ...
   defined as follows:
      ...
      -  the origin of the frame is defined as the intersection of the
 ...
 +Xscan, +Xbase o------->   |       +Xscan, +Xbase o------->   |
     ...
     ---------------------------        --------------------------------
       ...
       (2)    +Zbase                       (3)       +Zbase
                ^   ^ +Yscan                       ^
              .-|  /                               |
     +Zscan  /  | /     Science                    |       Science
       <-_~78deg|'ACS     Deck            ~180deg.-| ACS     Deck
          .'---.|___________.                ._/___|___________.
 +Xscan, +Xbase o------->   |              <-------o------->   |
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   The following in-flight calibrated detector mounting misalignment assuming
   nominal alignment of the rotation axis, provided as the boresight in
   'nadir' position was provided by A. Grigoriev on 10th May, 2017 [19].
   Please note that the scanner channel in 'nadir' position was not measured,
   but inferred from an offset in the 'solar direction':

      ACS_TIRVIM Boresight: ( 0.0, -0.99905, -0.04362 )

   The boresight is defined relative to the TGO_SPACECRAFT frame. Given
  ...
  +Xnad, +Xbase o------->   |        +Xocc, +Xbase o------->   |
         ...
         SA+Z             +Y*nad.--,        SA+Z     \         |__..--,
          ...
          ._________________.|               .______+Y*occ_____.|
                ...
                ^ +Y*spc                           ^ +Y*bby
                |   ^                              |
        ~78deg.-|  /    Science                    |       Science
        <-.__/  | /       Deck            ~180deg.-| ACS     Deck
    +Z*spc.__'--|.__________.                ._/___|___________.
  +Xspc, +Xbase o------->   |        +Xbby, +Xbase o------->   |
         ============o= +Ybase              ===\===|====o= +Ybase
   ...
   angles:
      ...
      TGO_ACS_TIRVIM_SCAN_SPC        +78.00
      TGO_ACS_TIRVIM_SCAN_NAD          0.00
      TGO_ACS_TIRVIM_SCAN_OCC        -63.76
      TGO_ACS_TIRVIM_SCAN_OCC_BS     -63.76
   ...
   The boresights are defined relative to the TGO_SPACECRAFT frame. Given
   ...
   data can be represented by the following rotation angles in degrees:
       ...
       nad
      M    = |0.0|  * |-2.50003062|  * |3.66153460E-15|
       base       Z                Y                   X

       occ
      M    = |-5.07029818|  * |-2.49902606|  * |-63.82900027|
       base               Z                Y                 X

       bsr
      M    = |-4.81530632|  * |-2.30860866|  * |-64.44415097|
       base               Z                Y                 X


   Since the SPICE frames subsystem calls for specifying the reverse
   transformation--going from the instrument or structure frame to the
   base frame--as compared to the description given above, the angles
   associated to the inverse of the previous rotation matrices are
   implemented in the TKFRAME_*_ANGLES keyword.
   ...
   \begindata
      ...
      TKFRAME_-143131_ANGLES           = (
                            0.0  -2.50003062  -180.00
                                         )
      ...
      TKFRAME_-143132_ANGLES           = (
                            2.44546602   0.5196278  -78.01109099
                                         )
      ...
      TKFRAME_-143133_ANGLES           = (
                            2.20905573e-32  2.50003062e+00 -3.65804955e-15
                                         )
      ...
      TKFRAME_-143134_ANGLES           = (
                            4.45570512e-16  5.65126024e+00  6.37183369e+01
                                         )
      ...
      TKFRAME_-143135_ANGLES            = (
                            -4.42963194e-16  5.33894122e+00  6.43470696e+01
                                          )
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   by A. Grigoriev on April 25 and 27, 2017 [19]:
   ...
   angles in degrees:
       ...
       sun
      M    = |-1.92001247|  * |-0.81363143|  * |-67.04293382|
       base               Z                Y                 X

       bsr
      M    = |-2.78146366|  * |-1.17006088|  * |-67.20278943|
       base               Z                Y                 X
   ...
   \begindata
      ...
      TKFRAME_-143140_ANGLES           = (
                   -2.16048015e-16  2.08523288e+00  6.70292997e+01
                                         )
                             ...
                             \ |/                               \ |/
                              \|                                 \|
                                  HGA                               HGA
                                        ...
                                        +Zsc, +X*base, +X*nad and
                                        +X*occ are out of the page.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   Therefore, the ACS MIR frame is defined as follows (from [9]):
      ...
      -  +Y axis is parallel to the spectrometer detector array's lines,
...
~~~~~~~~~~~~~~~~
   ...
   ----------------------------
                                    ...
                                    Science deck
                             ._____________.
   .__  _______________      |    <-------x|+Xfrend_____________  ___.
   |  \ \               \    |   +Zfrend  ||    /               \ \  |
   |  / /                \   |     ___    ||   /                / /  |
   |  \ \                 `. |    / _+Xsc || .'                 \ \  |
   |  / /             +Zsc <--------x) |  v|o |                 / /  |
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   as (from [10]):
      ...
      -  +Z axis is parallel to the flip mirror boresight that defines
         the spectrometer boresight; in 'nadir' flip mirror position is
         co-aligned with the -Y spacecraft axis;
   ...
   These diagrams illustrate the TGO_NOMAD_LNO_FMM frame for flip mirror
   ...
   side view:
    ...
    Flip mirror in 'nadir' position     Flip mirror in 'occultation' position
    -------------------------------     -------------------------------------
                ...
                |                       +Xfmm  ^   |         +Zfmm
                |       Science                 \  |_~67deg .^
                | NOMAD   Deck            NOMAD  \ |  \  .'    Science Deck
         . _____|___________.              . _____\| .'________.
  +Xfmm <-------o +Yfmm, +Ybase            <-------o +Yfmm, +Ybase
  +Xbase ============o========         +Xbase ==========o========
        SA+Z                |__..--,       SA+Z                |__..--,
          |            <-----o-..__| ME    |              <-----o-..__| ME
          |          +Xsc   || +Zsc        |          +Xsc     || +Zsc
...
~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   Since the LNO detector receives radiation through the flip mirror, its
   frame TGO_NOMAD_LNO is defined to be nominally co-aligned with the LNO
   flip mirror frame TGO_NOMAD_LNO_FMM. This frame is introduced to allow
   incorporating into the LNO frame chain any misalignment between the flip
   mirror boresight direction and the detector view directions.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 +X*nad <-------o +Y*nad, +Y*base          <-------o +Y*occ, +Y*base
 +X*base ============o========         +X*base =========o========
           SA+Z             |__..--,          SA+Z             |__..--,
          |            <-----o-..__| ME      |            <-----o-..__| ME
          |          +Xsc   || +Zsc          |          +Xsc   || +Zsc
   ...
   the +Y axis of the corresponding spectrometer base frames by the following
   angles:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 +X*base ============o========         +X*base =========o========
   ...
   +Y axis of the corresponding spectrometer base frames by the following
   angles:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   ----------------
                 ...
                 NOMAD  \ |  \  .'    Science Deck
                  ...
                  SA+Z               |__..--,
                   |            <-----o-..__| ME
                   |          +Xsc   || +Zsc
                   ._________________.|            +Zsc and +Yso are
                                   o-o|/|          out of the page.
                                    \|V +Ysc
                                     o  | :
                                      \ |/
   ...
   The following in-flight calibrated misalignment boresight was provided
   by Ian Thomas on October 26, 2021 [23]:

      NOMAD_SO Boresight:  ( -0.921772236, -0.387682744, 0.006167188 )
   ...
   \begindata
      ...
      TKFRAME_-143320_ANGLES           = ( -89.08862582,
                                           +67.18656155,
                                           +0.000000000 )
...
===============================================================================
   ...
   \begindata
      ...
      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C1'           )
      NAIF_BODY_CODE += ( -143501                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C2'           )
      NAIF_BODY_CODE += ( -143502                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C3'           )
      NAIF_BODY_CODE += ( -143503                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C4'           )
      NAIF_BODY_CODE += ( -143504                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C5'           )
      NAIF_BODY_CODE += ( -143505                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C6'           )
      NAIF_BODY_CODE += ( -143506                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C7'           )
      NAIF_BODY_CODE += ( -143507                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C8'           )
      NAIF_BODY_CODE += ( -143508                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C9'           )
      NAIF_BODY_CODE += ( -143509                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C10'          )
      NAIF_BODY_CODE += ( -143510                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C11'          )
      NAIF_BODY_CODE += ( -143511                       )

      NAIF_BODY_NAME += ( 'TGO_SPACECRAFT_C12'          )
      NAIF_BODY_CODE += ( -143512                       )

      NAIF_BODY_NAME += ( 'TGO_HGA_STOWED'              )
      NAIF_BODY_CODE += ( -143020                       )

      NAIF_BODY_NAME += ( 'TGO_HGA_APM'                 )
      NAIF_BODY_CODE += ( -143022                       )
      ...
      NAIF_BODY_NAME += ( 'TGO_SA+Z'                    )
      NAIF_BODY_CODE += ( -143011                       )
