...
class TestPhase9PDS4DocumentMiscChecksum:
    ...
    def test_spiceds_labeled_with_pds4_label_when_generated(self, mocks):
        ...
        # This class has exactly one construction site in the pipeline, so
        # assert_called_once_with is safe here.
        mocks.SpicedsPDS4Label.assert_called_once_with(
            mocks.Setup.return_value, doc_col, spiceds)

        # The label built above is what ends up assigned back onto the product.
        assert spiceds.label is mocks.SpicedsPDS4Label.return_value
    ...
    def test_spiceds_not_labeled_when_not_generated(self, mocks):
        ...
        mocks.SpicedsPDS4Label.assert_not_called()
