#
#   NAIF PDS4 Bundler (naif-pds4-bundler)
#
#   -------------------------------------------------------------------------
...
#   -------------------------------------------------------------------------
"""
The NAIF PDS4 Bundler (naif-pds4-bundler) is a a pipeline that generates a
PDS4 SPICE archive bundle.
...
def main(
    ...
    if args.faucet not in ["clear", "plan", "list", "staging", "final", ""]:
