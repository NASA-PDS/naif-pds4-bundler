...
from naif_pds4_bundle.classes.label import SpiceKernelPDS4Label
from naif_pds4_bundle.classes.label import MetaKernelPDS4Label
from naif_pds4_bundle.classes.label import OrbnumFilePDS4Label
from naif_pds4_bundle.classes.label import InventoryPDS4Label
from naif_pds4_bundle.classes.label import DocumentPDS4Label
from naif_pds4_bundle.classes.label import ChecksumPDS4Label
from naif_pds4_bundle.classes.label import BundlePDS4Label
from naif_pds4_bundle.classes.object import Object
from naif_pds4_bundle.classes.log import error_message
from naif_pds4_bundle.utils import creation_time
from naif_pds4_bundle.utils import current_date
from naif_pds4_bundle.utils import spk_coverage
from naif_pds4_bundle.utils import ck_coverage
from naif_pds4_bundle.utils import pck_coverage
from naif_pds4_bundle.utils import dsk_coverage
from naif_pds4_bundle.utils import md5
from naif_pds4_bundle.utils import add_carriage_return
from naif_pds4_bundle.utils import add_crs_to_file
from naif_pds4_bundle.utils import extension2type
from naif_pds4_bundle.utils import safe_make_directory
from naif_pds4_bundle.utils import mk2list
from naif_pds4_bundle.utils import get_latest_kernel
from naif_pds4_bundle.utils import type2extension
from naif_pds4_bundle.utils import compare_files
from naif_pds4_bundle.utils import match_patterns
from naif_pds4_bundle.utils import utf8len
from naif_pds4_bundle.utils import checksum_from_label
...
class MetaKernelProduct(Product):
    ...
    def write_product(self):
        ...
        if hasattr(self, 'mk_setup') and not self.setup.args.debug:
            ...
            print(f'        - Type "vi" and press ENTER to edit the '
...
class SpicedsProduct(object):
    ...
    def compare(self):
        ...
        try:
            ...
            val_spd = f'{self.setup.root_dir.replace("src","tests")}' \
