...
from naif_pds4_bundle.utils import get_context_products
from naif_pds4_bundle.utils import check_list_duplicates
from naif_pds4_bundle.classes.product import ReadmeProduct
    ...
    def validate_history(self):
        ...
        for rel in history:
            ...
            if not (products_in_checksum == products_in_history):
                ...
                logging.error(
                    set(products_in_checksum) ^ set(products_in_history))
