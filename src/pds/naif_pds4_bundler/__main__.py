...
optional arguments:
  ...
  -c CLEAR, --clear CLEAR
                        ...
                        therefore the pipeline is not exectued. If you
...
def main(
    ...
    :type kerlist: str
    :param checksum: Obtain MD5 Sums for products defined in the Cheksum Registry
                     file generated by a previous run. These files are stored in
                     in the ``working_directory`` specified in the configuration.
                     This argument is useful if large files have already been
    ...
    naif-pds4-bundler-{version}, NAIF PDS4 SPICE archive generation pipeline
      ...
      bundles for SPICE kernel archives.
        ...
        parser.add_argument(
            "-s",
            "--checksum",
            help="Obtain MD5 Sums for products defined in the Cheksum Registry "
                 "file generated by a previous run. These files are stored in "
                 "in the ``working_directory`` specified in the configuration. "
                 "This argument is useful if large files have already been "
                 "processed by a previous run.",
