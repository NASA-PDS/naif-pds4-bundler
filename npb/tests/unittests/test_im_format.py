...
class TestIMFormat(TestCase):
            ...
            with open(self.updated_config, 'w') as n:
                for line in c:
                    if '<information_model>1.5.0.0</information_model>' in line:
                        n.write('<information_model>1.A.0.0'
                                '</information_model>\n')
                    else:
                        n.write(line)
    ...
    def test_im_xml_incoherent(self):
        ...
        with open(self.config, 'r') as c:
            with open(self.updated_config, 'w') as n:
                for line in c:
                    if '<information_model>1.5.0.0</information_model>' in line:
                        n.write('<information_model>1.6.0.0'
                                '</information_model>\n')
                    else:
                        n.write(line)
    ...
    def test_im_schema_incoherent(self):
        ...
        with open(self.config, 'r') as c:
            with open(self.updated_config, 'w') as n:
                for line in c:
                    if '<schema_location>http://pds.nasa.gov/pds4/pds/v1 ' \
                       'http://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1500.xsd' \
                            in line:
                        n.write('<schema_location>http://pds.nasa.gov/pds4/pds/'
    ...
    def test_im_version_ascii(self):
        ...
        with open(self.config, 'r') as c:
            with open(self.updated_config, 'w') as n:
                for line in c:
                    if '<information_model>1.5.0.0</information_model>' in line:
                        n.write('<information_model>1.16.0.0'
                                '</information_model>\n')
                    elif '<xml_model>http://pds.nasa.gov/pds4/pds/v1/' \
                                'PDS4_PDS_1500.sch</xml_model>\n' \
                            in line:
                        n.write('<xml_model>http://pds.nasa.gov/pds4/pds/v1/'
                                'PDS4_PDS_1G00.sch</xml_model>\n')
                    elif '<schema_location>http://pds.nasa.gov/pds4/pds/v1 ' \
                       'http://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1500.xsd' \
                            in line:
                        n.write('<schema_location>http://pds.nasa.gov/pds4/pds/'
                                'v1 http://pds.nasa.gov/pds4/pds/v1/'
    ...
    def test_im_version_ascii_incorrect(self):
        ...
        with open(self.config, 'r') as c:
            with open(self.updated_config, 'w') as n:
                for line in c:
                    if '<information_model>1.5.0.0</information_model>' in line:
                        n.write('<information_model>10.16.11.20'
                                '</information_model>\n')
                    elif '<xml_model>http://pds.nasa.gov/pds4/pds/v1/' \
                         'PDS4_PDS_1500.sch</xml_model>\n' \
                            in line:
